module Analytics
  class TimelineCompanySurveyExporter < Analytics::BaseWorker
...
options = {user_id: '623d564ff67d8500092bfbcb', company_id: '66c496fb695d8cee6a6bb5bf'}
worker = Analytics::TimelineCompanySurveyExporter.new
